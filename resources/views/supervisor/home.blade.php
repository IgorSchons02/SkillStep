...
@section('content')
    <div class="container-fluid py-4">
        ...
        {{-- Banner de Boas-vindas SUPERVISOR --}}
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm card-hover h-100 border-start border-primary border-4">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <span class="text-muted fw-bold text-uppercase small d-block">Alunos</span>
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div
                ...
                <h5 class="fw-bold text-dark mb-0"><i class="bi bi-activity text-primary me-2"></i>Acompanhamento Recente
                </h5>
                                ...
                                <tr>
                                    <td class="ps-4 py-3">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-circle bg-light text-secondary fw-bold rounded-circle d-flex align-items-center justify-content-center me-3 border"
                                                style="width: 40px; height: 40px;">
                                                {{ strtoupper(substr($plano->aluno->nome ?? '?', 0, 1)) }}
                                            </div>
                                            <div>
                                                <div class="fw-bold text-dark">{{ $plano->aluno->nome ?? 'Aluno Removido' }}
                                                </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="text-muted small"><i class="bi bi-calendar-plus me-1"></i>Atribuído em
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span
                                                class="small fw-bold {{ $plano->progresso == 100 ? 'text-success' : 'text-primary' }}">{{ $plano->progresso }}%</span>
                                            @if($plano->progresso == 100)
                                                <span
                                                    class="badge bg-success-subtle text-success border border-success-subtle">Finalizado</span>
                                            @endif
                                        </div>
                                        <div class="progress" style="height: 6px;">
                                            <div class="progress-bar {{ $plano->progresso == 100 ? 'bg-success' : 'bg-primary' }}"
                                                style="width: {{ $plano->progresso }}%"></div>
                                        </div>
                                    </td>
                                    <td class="text-end pe-4">
                                        <a href="{{ route('meus-alunos.index', ['abrir_modal' => $plano->id]) }}"
                                            class="btn btn-sm btn-light border text-primary fw-bold"
                                            title="Abrir painel de acompanhamento">
