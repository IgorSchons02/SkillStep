...
<div class="login-card">
    <div class="login-header">
        <div class="mb-3">
            <i class="bi bi-rocket-takeoff-fill text-primary" style="font-size: 3rem; color: var(--accent) !important;"></i>
        </div>
        <h2>SkillStep</h2>
    ...
    <form action="{{ route('login.autenticar') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="email" id="email" name="email" class="form-control" placeholder="exemplo@cigam.com.br" required autofocus>
        </div>
